/**
 * https://github.com/rapportive-oss/storm-json/blob/master/src/main/java/com/rapportive/storm/scheme/SimpleJSONScheme.java
 */
...
/**
 * Deserialisation scheme for JSON values using the json-simple library. Emits
...
public class SimpleJSONScheme implements Scheme {
	 ...
	 *
	 * @param encoding
	 *            character encoding used to deserialise JSON from raw bytes
	 */
	 ...
	 *             if <tt>bytes</tt> does not contain valid JSON encoded using
	...
	public List<Object> deserialize(ByteBuffer byteBuffer) {
		final String chars;
		try {
			chars = new String(byteBuffer.array(), encoding);
		...
		try {
			...
			throw new IllegalArgumentException(e); // TODO this is a bit
													// impolite
		}
